...
<td>CategoryID</td>
<td>xsd:int</td>
<td>Specifies the identifier of the folder containing the filder definition.</td>
</tr>
<tr>
<td>Client</td>
<td>ClientID</td>
...
<td>DataFilter</td>
<td>FilterPart</td>
<td>Filter parts for a filter definition. This property specifies the rules for the filter, although these rules cannot be specified hierarchically. You can retrieve a data filter only if it doesn’t contain a data relationship. Use Today + or Today - qualifiers only with date values.</td>
</tr>
<tr>
<td>DataSource</td>
<td>APIObject</td>
<td>Source of data (such as a data extension or list) referred to by API as part of afilter definition</td>
</tr>
<tr>
<td>Description</td>
<td>xsd:string</td>
