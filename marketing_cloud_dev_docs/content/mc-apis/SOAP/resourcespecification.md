...
<samp class="codeph nolang">File://ETFTP/Import/image1.jpg</samp>
...
<td>URN</td>
<td>xsd:string</td>
<td>Specifies the Uniform Resource Name (URN) for the object, such as a file reference or URL.</td>
</tr>
</tbody>
</table>

##Related Items
[Create a Portfolio Item](creating_a_portfolio_object_via_the_web_service_api.htm)
